...
public class PhotonPlayer : IComparable<PhotonPlayer>, IComparable<int>, IEquatable<PhotonPlayer>, IEquatable<int>
{
    ...
    public PhotonPlayer GetNextFor(int currentPlayerId)
    {
        ...
        //UnityEngine.UnityEngine.Debug.LogWarning("UnityEngine.Debug. " + currentPlayerId + " lower: " + lowestId + " higher: " + nextHigherId + " ");
        //UnityEngine.UnityEngine.Debug.LogWarning(this.RoomReference.GetPlayer(currentPlayerId));
        //UnityEngine.UnityEngine.Debug.LogWarning(this.RoomReference.GetPlayer(lowestId));
        //if (nextHigherId != int.MaxValue) UnityEngine.UnityEngine.Debug.LogWarning(this.RoomReference.GetPlayer(nextHigherId));
