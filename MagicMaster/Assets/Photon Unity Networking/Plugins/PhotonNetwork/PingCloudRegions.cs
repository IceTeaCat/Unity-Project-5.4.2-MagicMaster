...
public class PingMonoEditor : PhotonPing
{
    ...
    public override bool Done()
    {
        ...
        //UnityEngine.Debug.Log("Got: " + SupportClassPun.ByteArrayToString(PingBytes));
        bool replyMatch = PingBytes[PingBytes.Length - 1] == PingId && read == PingLength;
        if (!replyMatch) UnityEngine.Debug.Log("ReplyMatch is false! ");
...
public class PingHttp : PhotonPing
{
    ...
    public override bool StartPing(string address)
    {
        ...
        UnityEngine.Debug.Log("StartPing: " + address);
...
public class PhotonPingManager
{
    ...
    public IEnumerator PingSocket(Region region)
    {
        ...
        {
            UnityEngine.Debug.Log("Using constructor for new PingNativeDynamic()"); // it seems on android, the Activator can't find the default Constructor
        ...
        for (int i = 0; i < Attempts; i++)
        {
            ...
            else if (ping.Successful && !overtime)
            {
                ...
                //UnityEngine.Debug.Log("region " + region.Code + " RTT " + region.Ping + " success: " + ping.Successful + " over: " + overtime);
            }
        ...
        //UnityEngine.Debug.Log("this.PingsRunning: " + this.PingsRunning + " this debug: " + ping.DebugString);
        yield return null;
    }
    ...
    public static string ResolveHost(string hostName)
    {
        ...
        try
        {
            ...
            //{
            //    UnityEngine.Debug.Log(hostName + " -> Adress: " + adr + " family: " + adr.AddressFamily.ToString());
            //}
        ...
        {
            UnityEngine.Debug.Log("Exception caught! " + e.Source + " Message: " + e.Message);
        }
