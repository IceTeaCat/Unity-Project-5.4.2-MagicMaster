...
public class PhotonStreamQueue
{
    ...
    private void BeginWritePackage()
    {
        ...
        if (this.m_SampleCount == 1)
        {
            ...
            //UnityEngine.Debug.Log( "Setting m_ObjectsPerSample to " + m_ObjectsPerSample );
        }
        else if (this.m_SampleCount > 1)
        {
            if (this.m_Objects.Count/this.m_SampleCount != this.m_ObjectsPerSample)
            {
                ...
                UnityEngine.Debug.LogWarning("Objects in List: " + this.m_Objects.Count + " / Sample Count: " + this.m_SampleCount + " = " + (this.m_Objects.Count/this.m_SampleCount) + " != " + this.m_ObjectsPerSample);
            }
        }
        ...
        /*if( m_SampleCount  > 1 )
        {
            UnityEngine.Debug.Log( "Check: " + m_Objects.Count + " / " + m_SampleCount + " = " + ( m_Objects.Count / m_SampleCount ) + " = " + m_ObjectsPerSample );
        }*/
    }
    ...
    public void Serialize(PhotonStream stream)
    {
        ...
        //UnityEngine.Debug.Log( "Serialize " + m_SampleCount + " samples with " + m_ObjectsPerSample + " objects per sample. object count: " + m_Objects.Count + " / " + ( m_SampleCount * m_ObjectsPerSample ) );
    ...
    public void Deserialize(PhotonStream stream)
    {
        ...
        //UnityEngine.Debug.Log( "Deserialized " + m_SampleCount + " samples with " + m_ObjectsPerSample + " objects per sample. object count: " + m_Objects.Count + " / " + ( m_SampleCount * m_ObjectsPerSample ) );
    }
}