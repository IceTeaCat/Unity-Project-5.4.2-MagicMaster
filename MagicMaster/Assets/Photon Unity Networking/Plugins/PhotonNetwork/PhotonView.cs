...
public class PhotonView : Photon.MonoBehaviour
{
    ...
    public int viewID
    {
        ...
        set
        {
            ...
            //UnityEngine.Debug.Log("Set viewID: " + value + " ->  owner: " + this.ownerId + " subId: " + this.subId);
        }
    }
    ...
    protected internal void OnDestroy()
    {
        if (!this.removedFromLocalViewList)
        {
            ...
            {
                UnityEngine.Debug.Log("PUN-instantiated '" + this.gameObject.name + "' got destroyed by engine. This is OK when loading levels. Otherwise use: PhotonNetwork.Destroy().");
            }
        }
    }
