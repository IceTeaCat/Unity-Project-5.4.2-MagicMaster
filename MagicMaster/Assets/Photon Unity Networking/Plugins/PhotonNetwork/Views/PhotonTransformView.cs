...
public class PhotonTransformView : MonoBehaviour, IPunObservable
{
    ...
    void DoDrawEstimatedPositionError()
    {
		...
		UnityEngine.Debug.DrawLine(targetPosition, transform.position, Color.red, 2f);
        UnityEngine.Debug.DrawLine(transform.position, transform.position + Vector3.up, Color.green, 2f);
		UnityEngine.Debug.DrawLine(targetPosition , targetPosition + Vector3.up, Color.red, 2f);
    }
