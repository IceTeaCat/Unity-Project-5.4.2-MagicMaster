...
public class PickupItem : Photon.MonoBehaviour, IPunObservable
{
    ...
    public void OnTriggerEnter(Collider other)
    {
        ...
        {
            //UnityEngine.Debug.Log("OnTriggerEnter() calls Pickup().");
            this.Pickup();
        }
    }
    ...
    public void PunPickup(PhotonMessageInfo msgInfo)
    {
        ...
        {
            // optional logging:
            UnityEngine.Debug.Log("Ignored PU RPC, cause item is inactive. " + this.gameObject + " SecondsBeforeRespawn: " + SecondsBeforeRespawn + " TimeOfRespawn: " + this.TimeOfRespawn + " respawn in future: " + (TimeOfRespawn > PhotonNetwork.time));
        ...
        else
        {
            ...
            //UnityEngine.Debug.Log("msg timestamp: " + msgInfo.timestamp + " time until respawn: " + timeUntilRespawn);
    ...
    internal void PunRespawn()
    {
        ...
        if (timeDiffToRespawnTime > 0.1f) UnityEngine.Debug.LogWarning("Spawn time is wrong by: " + timeDiffToRespawnTime + " (this is not an error. you just need to be aware of this.)");
        #endif
