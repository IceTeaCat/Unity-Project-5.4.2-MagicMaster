...
public class PhotonEditor : EditorWindow
{
    ...
    protected virtual void RegisterWithEmail(string email)
    {
        ...
        else
        {
            ...
            UnityEngine.Debug.LogWarning(client.Message + " ReturnCode: " + client.ReturnCode);
    ...
    public static void ClearRpcList()
    {
        ...
        {
            PhotonNetwork.PhotonServerSettings.RpcList.Clear();
            UnityEngine.Debug.LogWarning(CurrentLang.ServerSettingsCleanedWarning);
        }
    }
    ...
    public static System.Type[] GetAllSubTypesInScripts(System.Type aBaseClass)
    {
        ...
        foreach (var A in AS)
        {
            ...
            {
                // UnityEngine.Debug.Log("Skipping Assembly: " + A);
                continue;
            }

            //UnityEngine.Debug.Log("Assembly: " + A.FullName);
