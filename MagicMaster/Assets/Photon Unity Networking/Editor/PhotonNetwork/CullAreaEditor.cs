...
public class CullAreaEditor : Editor
{
    ...
    public void OnEnable()
    {
        ...
        {
            UnityEngine.Debug.LogWarning("Destroying newly created cull area because there is already one existing in the scene.");
    ...
    public void OnSceneGUI()
    {
        ...
        if (cullArea.transform.hasChanged)
        {
            ...
            if (cullArea.Size.x < 1.0f || cullArea.Size.y < 1.0f)
            {
                ...
                UnityEngine.Debug.LogWarning("Scaling on a single axis can not be lower than 1. Resetting...");
            }
