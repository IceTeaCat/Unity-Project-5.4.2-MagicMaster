...
public class PhotonAnimatorViewEditor : Editor
{
    ...
    private void CheckIfStoredParametersExist()
    {
        ...
        for (int i = 0; i < syncedParams.Count; ++i)
        {
            ...
            {
                UnityEngine.Debug.LogWarning("Parameter '" + this.m_Target.GetSynchronizedParameters()[i].Name + "' doesn't exist anymore. Removing it from the list of synchronized parameters");
